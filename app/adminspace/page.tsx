  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/adminspace/professors">
          <Card>
            <CardHeader>
        ...
        <Link href="/adminspace/departments">
          <Card>
            <CardHeader>
        ...
        <Link href="/adminspace/evaluation-methods">
          <Card>
            <CardHeader>
        ...
        <Link href="/adminspace/assignments">
          <Card>
            <CardHeader>
