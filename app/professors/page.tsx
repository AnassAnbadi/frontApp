...
import { fetchProfessors, createProfessor, updateProfessor, deleteProfessor } from '@/utils/api'
...
export default function ProfessorsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    if (isEditing) {
      const updatedProfessor = await updateProfessor(currentProfessor.id!, currentProfessor)
      setProfessors(professors.map(p => p.id === updatedProfessor.code ? updatedProfessor : p))
    } else {
